...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px; margin-top: 20px;">
  ...
  <div style="border: 1px solid #e1e4e8; border-radius: 8px; padding: 20px; background-color: #f6f8fa; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
    <h3 style="margin-top: 0; color: #0366d6;">🧮 Bank-Wide KYC Cleansing Engine</h3>
    <p><strong>The Challenge:</strong> 200,000+ unstructured, unformatted customer Unique IDs violating CBM compliance.</p>
  ...
  <div style="border: 1px solid #e1e4e8; border-radius: 8px; padding: 20px; background-color: #f6f8fa; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
    <h3 style="margin-top: 0; color: #0366d6;">💳 Visa Virtual Card & Wallet</h3>
    <p><strong>The Challenge:</strong> Launching secure, high-volume digital lending, deposits, and payment features in a mobile wallet ecosystem.</p>
    <p><strong>The Solution:</strong> Owned product roadmap, API integrations, and SIT/UAT validation phases to tie legacy banking architecture to mobile applications.</p>
    <p style="background: #e8f5e9; color: #388e3c; padding: 5px 10px; border-radius: 4px; display: inline-block; font-weight: bold; font-size: 0.9em;">Impact: Scaled FinTech Product Adoption</p>
  </div>

  <!-- CARD 3: ML RELIABILITY -->
  <div style="border: 1px solid #e1e4e8; border-radius: 8px; padding: 20px; background-color: #f6f8fa; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
